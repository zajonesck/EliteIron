  ...
  return (
    <>
      ...
      >
        ...
        {/* Scrollable body — contains cart items AND checkout so the inline card form can scroll */}
        <div className="flex-1 overflow-y-auto flex flex-col">
          {orderSuccess ? (
            ...
            <>
              ...
              {/* Checkout — inside scroll container so card form can expand and scroll */}
